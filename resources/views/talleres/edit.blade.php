...
@section('content')
            ...
            <h1 class="text-center"> Editar Taller</h1>

            <form class="row g-3 mt-5" method="POST" action="{{route('talleres.update', $taller->id)}}">
                @csrf
                @method('PUT')
                <div class="col-md-4">
